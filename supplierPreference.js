...
async function supplierPreference() {
    ...
    await page.click(".fc-navigation-button.fc-manage-vendors");
    await page.waitForSelector('.fc-dialog.fc-vendor-preferences-dialog');
    ...
    fs.writeFileSync('preferences.json', JSON.stringify(preferenceList, null, 2));
